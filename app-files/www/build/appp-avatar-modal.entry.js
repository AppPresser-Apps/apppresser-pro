...
import { a as alertController } from './overlays-ef00d22b.js';
...
const ApppAvatarModal = class {
  ...
  render() {
    return (h(Host, null, h("ion-header", null, h("ion-toolbar", null, h("ion-buttons", { slot: "start" }, h("ion-button", { onClick: () => this.modal.dismiss() }, h("ion-icon", { name: "close" }))), h("ion-buttons", { slot: "end" }, h("ion-button", { onClick: () => this.save(), color: "secondary", fill: "clear", style: { '--padding-end': '20px', '--padding-start': '20px' } }, "Save")))), h("ion-content", { fullscreen: true }, h("div", { style: { 'width': '100%', 'height': '100%', 'display': 'flex', 'justify-content': 'center', 'align-items': 'center' } }, h("div", { style: { 'width': '300px', 'height': '300px' } }, h("img", { onLoad: (e) => this.loadCropper(e), onError: (err) => this.showErrorModal(err), src: this.avatarUrl, hidden: true })))), h("ion-footer", { style: { 'border-top': '0.55px solid rgba(0, 0, 0, 0.2)', 'background': '#ffffff' } }, h("ion-range", { onIonChange: $event => this.zoomRangeChange($event.detail), step: 0.1, value: 0, min: 0, max: 1, style: { '--knob-size': 'calc(10px * 2)' } }, h("ion-label", { slot: "start", style: { padding: '0 5px' } }, h("ion-icon", { name: "remove-circle-outline" })), h("ion-label", { slot: "end", style: { padding: '0 5px' } }, h("ion-icon", { name: "add-circle-outline" }))))));
  }
  get el() { return getElement(this); }
};
ApppAvatarModal.style = apppAvatarModalCss;

export { ApppAvatarModal as appp_avatar_modal };
