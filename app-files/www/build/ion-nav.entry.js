import { r as registerInstance, t as createEvent, i as Build, l as h, q as getElement } from './index-6c5afe2f.js';
...
import { k as assert, s as shallowEqualStringMap } from './helpers-6885e51a.js';
import { l as lifecycle, L as LIFECYCLE_WILL_UNLOAD, a as LIFECYCLE_WILL_LEAVE, b as LIFECYCLE_DID_LEAVE, t as transition, s as setPageHidden } from './index-0fa2abb2.js';
...
const Nav = class {
  ...
  async componentDidLoad() {
    this.rootChanged();
    this.gesture = (await import('./swipe-back-b6de6ccd.js')).createSwipeBackGesture(this.el, this.canStart.bind(this), this.onStart.bind(this), this.onMove.bind(this), this.onEnd.bind(this));
