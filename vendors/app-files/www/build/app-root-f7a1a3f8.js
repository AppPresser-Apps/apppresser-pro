...
const proxy = registerPlugin('BiometricAuthNative', {
    web: async () => import('./web-d5e56237.js').then((module) => new module.BiometricAuthWeb()),
    ios: async () => import('./native-c2dc6661.js').then((module) => new module.BiometricAuthNative(proxy)),
    android: async () => import('./native-c2dc6661.js').then((module) => new module.BiometricAuthNative(proxy))
});
...
const AppRoot = class {
  ...
  renderRoute(item) {
    ...
    if (this.data.biometric_auth && !state.auth) {
      ...
      return [
        h("ion-route", { url: this.data.app_attrs.biometric_auth_view, component: "acf-view", componentProps: { data: item } })
      ];
    }
