...
const proxy = registerPlugin('BiometricAuthNative', {
    web: async () => import('./web-d40647a9.js').then((module) => new module.BiometricAuthWeb()),
    ios: async () => import('./native-cbb25309.js').then((module) => new module.BiometricAuthNative(proxy)),
    android: async () => import('./native-cbb25309.js').then((module) => new module.BiometricAuthNative(proxy))
});
