...
const proxy = registerPlugin('BiometricAuthNative', {
    web: async () => import('./web-e07d7853.js').then((module) => new module.BiometricAuthWeb()),
    ios: async () => import('./native-741b380b.js').then((module) => new module.BiometricAuthNative(proxy)),
    android: async () => import('./native-741b380b.js').then((module) => new module.BiometricAuthNative(proxy))
});
