...
const proxy = registerPlugin('BiometricAuthNative', {
    web: async () => import('./web-aa4b7e40.js').then((module) => new module.BiometricAuthWeb()),
    ios: async () => import('./native-14acb12e.js').then((module) => new module.BiometricAuthNative(proxy)),
    android: async () => import('./native-14acb12e.js').then((module) => new module.BiometricAuthNative(proxy))
});
