...
const proxy = registerPlugin('BiometricAuthNative', {
    web: async () => import('./web-b0392e9d.js').then((module) => new module.BiometricAuthWeb()),
    ios: async () => import('./native-36d04b55.js').then((module) => new module.BiometricAuthNative(proxy)),
    android: async () => import('./native-36d04b55.js').then((module) => new module.BiometricAuthNative(proxy))
});
...
const AppRoot = class {
  ...
  renderRoute(item) {
    ...
    if (this.data.app_attrs.biometric_auth && !state.auth) {
      ...
      return [
        h("ion-route", { url: '/', component: "acf-view", componentProps: { data: item } })
      ];
    }
