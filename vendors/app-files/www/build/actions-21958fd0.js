...
const proxy = registerPlugin('BiometricAuthNative', {
    web: async () => import('./web-5692dfe4.js').then((module) => new module.BiometricAuthWeb()),
    ios: async () => import('./native-db87b630.js').then((module) => new module.BiometricAuthNative(proxy)),
    android: async () => import('./native-db87b630.js').then((module) => new module.BiometricAuthNative(proxy))
});
