...
const proxy = registerPlugin('BiometricAuthNative', {
    web: async () => import('./web-8bce25fa.js').then((module) => new module.BiometricAuthWeb()),
    ios: async () => import('./native-ab194f2f.js').then((module) => new module.BiometricAuthNative(proxy)),
    android: async () => import('./native-ab194f2f.js').then((module) => new module.BiometricAuthNative(proxy))
});
...
export { BiometryType as B, resumeBioMetrics as a, BiometryErrorType as b, checkBioMetrics as c, getBiometryName as d, BiometryError as e, getBioMetrics as g, runAction as r };
