...
const proxy = registerPlugin('BiometricAuthNative', {
    web: async () => import('./web-08d3a1e0.js').then((module) => new module.BiometricAuthWeb()),
    ios: async () => import('./native-e1e3acdf.js').then((module) => new module.BiometricAuthNative(proxy)),
    android: async () => import('./native-e1e3acdf.js').then((module) => new module.BiometricAuthNative(proxy))
});
