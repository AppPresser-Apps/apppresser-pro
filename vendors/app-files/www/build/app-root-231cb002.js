...
const proxy = registerPlugin('BiometricAuthNative', {
    web: async () => import('./web-9e2cd119.js').then((module) => new module.BiometricAuthWeb()),
    ios: async () => import('./native-bc664f14.js').then((module) => new module.BiometricAuthNative(proxy)),
    android: async () => import('./native-bc664f14.js').then((module) => new module.BiometricAuthNative(proxy))
});
