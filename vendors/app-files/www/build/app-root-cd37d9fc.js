...
const proxy = registerPlugin('BiometricAuthNative', {
    web: async () => import('./web-62536ac1.js').then((module) => new module.BiometricAuthWeb()),
    ios: async () => import('./native-65d200c4.js').then((module) => new module.BiometricAuthNative(proxy)),
    android: async () => import('./native-65d200c4.js').then((module) => new module.BiometricAuthNative(proxy))
});
...
const AppRoot = class {
  ...
  renderRoute(item) {
    ...
    if (this.data.app_attrs.biometric_auth && !state.auth) {
      ...
      return [
        h("ion-route", { url: '/bioauth', component: "acf-view", componentProps: { data: item } })
      ];
    }
