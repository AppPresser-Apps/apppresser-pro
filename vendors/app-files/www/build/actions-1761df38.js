...
const proxy = registerPlugin('BiometricAuthNative', {
    web: async () => import('./web-bf5a511b.js').then((module) => new module.BiometricAuthWeb()),
    ios: async () => import('./native-6ab6639c.js').then((module) => new module.BiometricAuthNative(proxy)),
    android: async () => import('./native-6ab6639c.js').then((module) => new module.BiometricAuthNative(proxy))
});
