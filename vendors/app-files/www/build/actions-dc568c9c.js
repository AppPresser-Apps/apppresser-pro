...
const proxy = registerPlugin('BiometricAuthNative', {
    web: async () => import('./web-c7204cdd.js').then((module) => new module.BiometricAuthWeb()),
    ios: async () => import('./native-9e0c93d4.js').then((module) => new module.BiometricAuthNative(proxy)),
    android: async () => import('./native-9e0c93d4.js').then((module) => new module.BiometricAuthNative(proxy))
});
