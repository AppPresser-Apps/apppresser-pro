 ...
 */
  ...
  */
  async getToken() {
    ...
    if (data.value) {
      const user_obj = JSON.parse(data.value).data;
  ...
  async getUserId() {
    ...
    return (_a = JSON.parse(userData)) === null || _a === void 0 ? void 0 : _a.data.user_id;
  }
  async getAuthHeaders() {
    var _a;
    const userData = (_a = JSON.parse((await Preferences.get({ key: 'auth' })).value)) === null || _a === void 0 ? void 0 : _a.data;
