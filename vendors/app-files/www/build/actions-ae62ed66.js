...
const proxy = registerPlugin('BiometricAuthNative', {
    web: async () => import('./web-ed716ffe.js').then((module) => new module.BiometricAuthWeb()),
    ios: async () => import('./native-dac423c4.js').then((module) => new module.BiometricAuthNative(proxy)),
    android: async () => import('./native-dac423c4.js').then((module) => new module.BiometricAuthNative(proxy))
});
