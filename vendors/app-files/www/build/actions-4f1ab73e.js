...
const proxy = registerPlugin('BiometricAuthNative', {
    web: async () => import('./web-2d9a7cfd.js').then((module) => new module.BiometricAuthWeb()),
    ios: async () => import('./native-123e8ced.js').then((module) => new module.BiometricAuthNative(proxy)),
    android: async () => import('./native-123e8ced.js').then((module) => new module.BiometricAuthNative(proxy))
});
