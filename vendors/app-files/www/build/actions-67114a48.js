...
const proxy = registerPlugin('BiometricAuthNative', {
    web: async () => import('./web-b7a890c9.js').then((module) => new module.BiometricAuthWeb()),
    ios: async () => import('./native-730a4c70.js').then((module) => new module.BiometricAuthNative(proxy)),
    android: async () => import('./native-730a4c70.js').then((module) => new module.BiometricAuthNative(proxy))
});
...
export { BiometryType as B, authBiometrics as a, resumeBioMetrics as b, checkBioMetrics as c, BiometryErrorType as d, getBiometryName as e, BiometryError as f, getBioMetrics as g, runAction as r };
