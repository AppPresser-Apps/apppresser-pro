...
const proxy = registerPlugin('BiometricAuthNative', {
    web: async () => import('./web-ba4572a4.js').then((module) => new module.BiometricAuthWeb()),
    ios: async () => import('./native-d3c90193.js').then((module) => new module.BiometricAuthNative(proxy)),
    android: async () => import('./native-d3c90193.js').then((module) => new module.BiometricAuthNative(proxy))
});
