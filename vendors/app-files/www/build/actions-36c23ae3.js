...
const proxy = registerPlugin('BiometricAuthNative', {
    web: async () => import('./web-9d9c8bc7.js').then((module) => new module.BiometricAuthWeb()),
    ios: async () => import('./native-a57a12bc.js').then((module) => new module.BiometricAuthNative(proxy)),
    android: async () => import('./native-a57a12bc.js').then((module) => new module.BiometricAuthNative(proxy))
});
