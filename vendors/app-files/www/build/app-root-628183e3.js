...
const proxy = registerPlugin('BiometricAuthNative', {
    web: async () => import('./web-865d90c4.js').then((module) => new module.BiometricAuthWeb()),
    ios: async () => import('./native-cc58a12a.js').then((module) => new module.BiometricAuthNative(proxy)),
    android: async () => import('./native-cc58a12a.js').then((module) => new module.BiometricAuthNative(proxy))
});
