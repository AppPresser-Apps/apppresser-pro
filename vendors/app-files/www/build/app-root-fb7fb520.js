...
const proxy = registerPlugin('BiometricAuthNative', {
    web: async () => import('./web-87e9088f.js').then((module) => new module.BiometricAuthWeb()),
    ios: async () => import('./native-6640c45a.js').then((module) => new module.BiometricAuthNative(proxy)),
    android: async () => import('./native-6640c45a.js').then((module) => new module.BiometricAuthNative(proxy))
});
...
const AppRoot = class {
  ...
  renderRoute(item) {
    ...
    if (this.data.biometric_auth && !state.auth) {
      console.log('attr', this.data.biometric_auth);
      console.log('attr', this.data.biometric_auth_view);
      return [
        h("ion-route", { url: this.data.biometric_auth_view, component: "acf-view", componentProps: { data: item } })
      ];
    }
