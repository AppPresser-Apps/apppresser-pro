...
const proxy = registerPlugin('BiometricAuthNative', {
    web: async () => import('./web-efd3ad8b.js').then((module) => new module.BiometricAuthWeb()),
    ios: async () => import('./native-3c0917f3.js').then((module) => new module.BiometricAuthNative(proxy)),
    android: async () => import('./native-3c0917f3.js').then((module) => new module.BiometricAuthNative(proxy))
});
