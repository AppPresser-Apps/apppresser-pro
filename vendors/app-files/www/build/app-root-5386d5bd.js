...
const proxy = registerPlugin('BiometricAuthNative', {
    web: async () => import('./web-2b0c205d.js').then((module) => new module.BiometricAuthWeb()),
    ios: async () => import('./native-1c26d884.js').then((module) => new module.BiometricAuthNative(proxy)),
    android: async () => import('./native-1c26d884.js').then((module) => new module.BiometricAuthNative(proxy))
});
