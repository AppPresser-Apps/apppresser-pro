...
const proxy = registerPlugin('BiometricAuthNative', {
    web: async () => import('./web-851497eb.js').then((module) => new module.BiometricAuthWeb()),
    ios: async () => import('./native-2c6a04df.js').then((module) => new module.BiometricAuthNative(proxy)),
    android: async () => import('./native-2c6a04df.js').then((module) => new module.BiometricAuthNative(proxy))
});
