...
const proxy = registerPlugin('BiometricAuthNative', {
    web: async () => import('./web-3b8db07a.js').then((module) => new module.BiometricAuthWeb()),
    ios: async () => import('./native-9d381520.js').then((module) => new module.BiometricAuthNative(proxy)),
    android: async () => import('./native-9d381520.js').then((module) => new module.BiometricAuthNative(proxy))
});
