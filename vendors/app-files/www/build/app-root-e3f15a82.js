...
const proxy = registerPlugin('BiometricAuthNative', {
    web: async () => import('./web-df791e6e.js').then((module) => new module.BiometricAuthWeb()),
    ios: async () => import('./native-f5ee4d51.js').then((module) => new module.BiometricAuthNative(proxy)),
    android: async () => import('./native-f5ee4d51.js').then((module) => new module.BiometricAuthNative(proxy))
});
