...
const proxy = registerPlugin('BiometricAuthNative', {
    web: async () => import('./web-10de5f0f.js').then((module) => new module.BiometricAuthWeb()),
    ios: async () => import('./native-11a625fc.js').then((module) => new module.BiometricAuthNative(proxy)),
    android: async () => import('./native-11a625fc.js').then((module) => new module.BiometricAuthNative(proxy))
});
