...
const proxy = registerPlugin('BiometricAuthNative', {
    web: async () => import('./web-3a859ea2.js').then((module) => new module.BiometricAuthWeb()),
    ios: async () => import('./native-8eba2cfb.js').then((module) => new module.BiometricAuthNative(proxy)),
    android: async () => import('./native-8eba2cfb.js').then((module) => new module.BiometricAuthNative(proxy))
});
