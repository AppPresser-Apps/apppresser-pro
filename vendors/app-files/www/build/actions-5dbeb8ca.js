...
const proxy = registerPlugin('BiometricAuthNative', {
    web: async () => import('./web-f6a4ada1.js').then((module) => new module.BiometricAuthWeb()),
    ios: async () => import('./native-8c0c250a.js').then((module) => new module.BiometricAuthNative(proxy)),
    android: async () => import('./native-8c0c250a.js').then((module) => new module.BiometricAuthNative(proxy))
});
