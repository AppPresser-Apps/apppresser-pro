...
const proxy = registerPlugin('BiometricAuthNative', {
    web: async () => import('./web-37a3618a.js').then((module) => new module.BiometricAuthWeb()),
    ios: async () => import('./native-b6327baa.js').then((module) => new module.BiometricAuthNative(proxy)),
    android: async () => import('./native-b6327baa.js').then((module) => new module.BiometricAuthNative(proxy))
});
