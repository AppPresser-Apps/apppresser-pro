...
const proxy = registerPlugin('BiometricAuthNative', {
    web: async () => import('./web-920253b5.js').then((module) => new module.BiometricAuthWeb()),
    ios: async () => import('./native-674482be.js').then((module) => new module.BiometricAuthNative(proxy)),
    android: async () => import('./native-674482be.js').then((module) => new module.BiometricAuthNative(proxy))
});
