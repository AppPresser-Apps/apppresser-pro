...
const proxy = registerPlugin('BiometricAuthNative', {
    web: async () => import('./web-4abb91ce.js').then((module) => new module.BiometricAuthWeb()),
    ios: async () => import('./native-9bad3d53.js').then((module) => new module.BiometricAuthNative(proxy)),
    android: async () => import('./native-9bad3d53.js').then((module) => new module.BiometricAuthNative(proxy))
});
